...
class ReuseSettingsViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var notificationSubtitle = "Reuse"
    var notificationBody = "Don't forget to log your reusables!"
    var notificationSound = UNNotificationSound.default
    
    
    //user default keystrings
    var numTimesToLogKey = "numTimesToLogReuse"
    var trackGoalToggleKey = "reuseTrackToggleIsOn"
    var trackAlertToggleFROMITSFuncKey = "reuseTrackAlertToggleIsOnFROMITSFunc"
    var currentFrequencyRowKey = "reuseCurrentFrequencyRow"
    var arrActiveDays0s1sKey = "arrayOfActiveReuseDays"
    var boolHoldingIfArrActiveDaysEditedKey = "reuseActiveDaysEditedBool"
    
    var setSundayBGArrPosKey = "reuseSunBG"
    var setMondayBGArrPosKey = "reuseMonBG"
    var setTuesdayBGArrPosKey = "reuseTueBG"
    var setWednesdayBGArrPosKey = "reuseWedBG"
    var setThursdayBGArrPosKey = "reuseThuBG"
    var setFridayBGArrPosKey = "reuseFriBG"
    var setSaturdayBGArrPosKey = "reuseSatBG"
    
    var prevFrequenceyRowValKey = "prevReuseFrequencyRowVal"
    var goalEndDateKey = "reuseGoalEndDate"
    var currentNumberOfLoggingsKey = "currentNumOfReuseLoggings"
    var leafAddedYetKey = "reuseLeafAddedYet"
    var trackAlertToggleKey = "reuseTrackAlertToggleIsOn"
    var startedBeforeKey = "startedBeforeReuse"
    var alertTimeStringKey = "reuseAlertTimeString"
    var recycleEndDateSetKey = "reuseEndDateHasBeenSet"
