...
class RecycleSettingsViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var notificationSubtitle = "Recycle"
    var notificationBody = "Don't forget to log your recycling!"
    var notificationSound = UNNotificationSound.default
    
    
    //user default keystrings
    var numTimesToLogKey = "numTimesToLogRecycle"
    var trackGoalToggleKey = "recycleTrackToggleIsOn"
    var trackAlertToggleFROMITSFuncKey = "recycleTrackAlertToggleIsOnFROMITSFunc"
    var currentFrequencyRowKey = "recycleCurrentFrequencyRow"
    var arrActiveDays0s1sKey = "arrayOfActiveRecycleDays"
    var boolHoldingIfArrActiveDaysEditedKey = "recycleActiveDaysEditedBool"
    
    var setSundayBGArrPosKey = "recycleSunBG"
    var setMondayBGArrPosKey = "recycleMonBG"
    var setTuesdayBGArrPosKey = "recycleTueBG"
    var setWednesdayBGArrPosKey = "recycleWedBG"
    var setThursdayBGArrPosKey = "recycleThuBG"
    var setFridayBGArrPosKey = "recycleFriBG"
    var setSaturdayBGArrPosKey = "recycleSatBG"
    
    var prevFrequenceyRowValKey = "prevRecycleFrequencyRowVal"
    var goalEndDateKey = "recycleGoalEndDate"
    var currentNumberOfLoggingsKey = "currentNumOfRecycleLoggings"
    var leafAddedYetKey = "recycleLeafAddedYet"
    var trackAlertToggleKey = "recycleTrackAlertToggleIsOn"
    var startedBeforeKey = "startedBefore"
    var alertTimeStringKey = "recycleAlertTimeString"
...
//convert global time returned by picker to dates we can use well
extension Date{
