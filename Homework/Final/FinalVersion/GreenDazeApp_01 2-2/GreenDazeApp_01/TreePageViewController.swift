...
/**************************************************************************/
    ...
    func determineRecycleGoalCompletionPercent() -> Double{
        ...
        //dec = (dec * 100) / 100
        let perc = dec * 100;
        recyclePercentLabel?.text = String(format: "%.2f%", perc);
        return dec
    }
    ...
    func determineReuseGoalCompletionPercent() -> Double{
        ...
        //dec = (dec * 100) / 100
        let perc = dec * 100;
        reusePercentLabel?.text = String(format: "%.2f%", perc);
        return dec
    }
    ...
    func determineTransportGoalCompletionPercent() -> Double{
        ...
        //dec = (dec * 100) / 100
        let perc = dec * 100;
        transportPercentLabel?.text = String(format: "%.2f%", perc);
        return dec
    }
    ...
    func determineWaterGoalCompletionPercent() -> Double{
        ...
        //dec = (dec * 100) / 100
        let perc = dec * 100;
        waterPercentLabel?.text = String(format: "%.2f%", perc);
        return dec
    }
