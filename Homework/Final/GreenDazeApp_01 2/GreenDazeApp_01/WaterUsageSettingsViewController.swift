...
class WaterUsageSettingsViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var notificationSubtitle = "Water Usage"
    var notificationBody = "Don't forget to log your water usage!"
    var notificationSound = UNNotificationSound.default
    
    
    //user default keystrings
    var numTimesToLogKey = "numTimesToLogWater"
    var trackGoalToggleKey = "waterTrackToggleIsOn"
    var trackAlertToggleFROMITSFuncKey = "waterTrackAlertToggleIsOnFROMITSFunc"
    var currentFrequencyRowKey = "waterCurrentFrequencyRow"
    var arrActiveDays0s1sKey = "arrayOfActiveWaterDays"
    var boolHoldingIfArrActiveDaysEditedKey = "waterActiveDaysEditedBool"
    
    var setSundayBGArrPosKey = "waterSunBG"
    var setMondayBGArrPosKey = "waterMonBG"
    var setTuesdayBGArrPosKey = "waterTueBG"
    var setWednesdayBGArrPosKey = "waterWedBG"
    var setThursdayBGArrPosKey = "waterThuBG"
    var setFridayBGArrPosKey = "waterFriBG"
    var setSaturdayBGArrPosKey = "waterSatBG"
    
    var prevFrequenceyRowValKey = "prevWaterFrequencyRowVal"
    var goalEndDateKey = "waterGoalEndDate"
    var currentNumberOfLoggingsKey = "currentNumOfWaterLoggings"
    var leafAddedYetKey = "waterLeafAddedYet"
    var trackAlertToggleKey = "waterTrackAlertToggleIsOn"
    var startedBeforeKey = "startedBeforeWater"
    var alertTimeStringKey = "waterAlertTimeString"
    var recycleEndDateSetKey = "waterEndDateHasBeenSet"
